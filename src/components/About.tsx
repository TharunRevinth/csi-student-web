    ...
    <section id="about" className="bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40">
        <motion.div 
          ...
          className="mb-20"
        >
          <h2 className="text-sm font-black text-white uppercase tracking-[0.5em] sm:tracking-[1em] mb-6">Core Identity</h2>
        ...
        <TextReveal 
          body={revealText} 
          className="relative w-full h-[120vh] sm:h-[180vh]" 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-40">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          >
            ...
            <div className="absolute -top-3 -right-3 w-6 h-6 sm:w-8 sm:h-8 bg-white"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 gap-12 sm:gap-16">
            ...
            >
              <h3 className="text-white font-black text-[10px] sm:text-sm uppercase tracking-[0.5em] mb-4 sm:mb-6 opacity-40">Our Vision</h3>
              <p className="text-white/80 text-lg sm:text-xl font-light leading-relaxed border-l-2 border-white pl-6 sm:pl-8">
            ...
            >
              <h3 className="text-white font-black text-[10px] sm:text-sm uppercase tracking-[0.5em] mb-4 sm:mb-6 opacity-40">Our Mission</h3>
              <p className="text-white/80 text-lg sm:text-xl font-light leading-relaxed border-l-2 border-white pl-6 sm:pl-8">
